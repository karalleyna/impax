...
def look_at(eye, center, world_up):
    ...
    w_column = jnp.array(batch_size * [[0.0, 0.0, 0.0, 1.0]], dtype=jnp.float32)  # [batch_size, 4]
    ...
    view_rotation = jnp.concatenate([view_rotation, w_column], axis=2)  # [batch_size, 4, 4]
    ...
    view_translation = jnp.concatenate([view_translation, jnp.reshape(w_column, [batch_size, 1, 4])], 1)
...
def roll_pitch_yaw_to_rotation_matrices(roll_pitch_yaw):
    ...
    shape = jnp.concatenate([jnp.shape(rotation)[:-1], [3, 3]], axis=0)
